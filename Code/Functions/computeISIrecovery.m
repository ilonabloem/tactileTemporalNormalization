function [ISIrecover, ts, w] = sx_computeISIrecovery(data,t,stim_info,srate,w,shift,metric, debug, savefig)
...
% Set parameters
conditionsOfInterest = {'ONE-PULSE-3','ONE-PULSE-4','TWO-PULSE'};
