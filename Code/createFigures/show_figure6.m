function show_figure6(saveFig, figDir)
%
...
for wModel = 1:numel(models)
    ...
    out             = createSmoothPrediction(allResults.(sprintf('%sparams', model)), model);
...
if saveFig > 0
    print(summaryFig, fullfile(figDir, sprintf('fig6_fMRI_summedResponses')), '-dpdf')
end
